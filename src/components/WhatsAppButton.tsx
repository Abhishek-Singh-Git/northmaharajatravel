      ...
      {visible && (
        ...
        >
          ...
          <AnimatePresence>
            {tooltip && (
              <motion.div
                ...
                className="bg-white text-midnight text-xs font-body font-semibold px-4 py-2 rounded-full shadow-lg shadow-midnight/10 whitespace-nowrap"
              >
          ...
          <a
            ...
            className="relative w-14 h-14 rounded-full bg-gradient-to-br from-green-400 to-green-600 flex items-center justify-center shadow-xl shadow-green-500/40 hover:shadow-green-500/60 hover:scale-110 transition-all duration-300"
          >
            {/* Pulse rings */}
